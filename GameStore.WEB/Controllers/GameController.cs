...
namespace GameStore.WEB.Controllers
{
    public class GameController : Controller
    {
        ...
        [HttpPost("game/{key}/createComment")]
        public ActionResult CreateComment(CommentViewModel commentViewModel, string key)
        {
            commentViewModel.GameKey = key;
            ...
            if (!ModelState.IsValid)
            {
                commentViewModel.Comments = _mapper.Map<List<CommentViewModel>>
                    (_commentService.GetAllByGameKey(key, true));
        ...
        [HttpGet("game/{key}/removeComment/{id}")]
        public ActionResult<CommentViewModel> RemoveComment(int id, string key)
        {
