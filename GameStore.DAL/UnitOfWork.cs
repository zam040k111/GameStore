...
namespace GameStore.DAL
{
    public class UnitOfWork : IUnitOfWork
    {
            ...
            TFilter filter)
        {
            ...
            var firstCollection = GameRepository.GetByFilter(pipeline, filter);
            var pageSize = (filter as GameFilterEntity).PageSize;
            (filter as GameFilterEntity).PageSize -= firstCollection.Count(); 
            ...
            return firstCollection.Union(mapped);
        }
